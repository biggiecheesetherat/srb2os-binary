...
state_t states[NUMSTATES] =
{
	...
	// CA_FLY/CA_SWIM
	{SPR_PLAY, 0, -1, {NULL}, 0,  0, S_NULL, SPR2_FLY},  // S_PLAY_FLY
	{SPR_PLAY, 0, -1, {NULL}, 0,  0, S_NULL, SPR2_SWIM}, // S_PLAY_SWIM
	{SPR_PLAY, 0, -1, {NULL}, 0,  0, S_NULL, SPR2_TIRE}, // S_PLAY_FLY_TIRED

	// CA_GLIDEANDCLIMB
	{SPR_PLAY, 0, -1, {NULL}, 0,  0, S_NULL,      SPR2_GLID}, // S_PLAY_GLIDE
	{SPR_PLAY, 0,  7, {NULL}, 0,  0, S_PLAY_STND, SPR2_LAND}, // S_PLAY_GLIDE_LANDING
	{SPR_PLAY, 0, -1, {NULL}, 0,  4, S_NULL,      SPR2_CLNG}, // S_PLAY_CLING
	{SPR_PLAY, 0, -1, {NULL}, 0,  0, S_NULL,      SPR2_CLMB}, // S_PLAY_CLIMB

	// CA_FLOAT/CA_SLOWFALL
	{SPR_PLAY, 0, -1, {NULL}, 0,  0, S_NULL, SPR2_FLT},  // S_PLAY_FLOAT
	{SPR_PLAY, 0, -1, {NULL}, 0,  0, S_NULL, SPR2_FRUN}, // S_PLAY_FLOAT_RUN

	// CA_BOUNCE
	{SPR_PLAY, 0, -1, {NULL}, 0, 0, S_NULL, SPR2_BNCE}, // S_PLAY_BOUNCE
	{SPR_PLAY, 0, -1, {NULL}, 0, 0, S_NULL, SPR2_LAND}, // S_PLAY_BOUNCE_LANDING

	// CA2_GUNSLINGER
	{SPR_PLAY, 0, -1, {NULL}, 0, 0, S_NULL,      SPR2_FIRE}, // S_PLAY_FIRE
	{SPR_PLAY, 0, 15, {NULL}, 0, 0, S_PLAY_STND, SPR2_FIRE}, // S_PLAY_FIRE_FINISH

	// CA_TWINSPIN
	{SPR_PLAY, 0, -1, {NULL}, 0, 0, S_NULL, SPR2_TWIN}, // S_PLAY_TWINSPIN

	// CA2_MELEE
	{SPR_PLAY, 0, -1, {NULL}, 0, 0, S_NULL,      SPR2_MLEE}, // S_PLAY_MELEE
	...
	// NiGHTS Player
	{SPR_PLAY, 0, -1, {NULL}, 0, 0, S_NULL, SPR2_NSTD}, // S_PLAY_NIGHTS_STAND
	{SPR_PLAY, 0, -1, {NULL}, 0, 0, S_NULL, SPR2_NFLT}, // S_PLAY_NIGHTS_FLOAT
	{SPR_PLAY, 0, -1, {NULL}, 0, 0, S_NULL, SPR2_NFLY}, // S_PLAY_NIGHTS_FLY
	{SPR_PLAY, 0, -1, {NULL}, 0, 0, S_NULL, SPR2_NDRL}, // S_PLAY_NIGHTS_DRILL
	{SPR_PLAY, 0, -1, {NULL}, 0, 0, S_NULL, SPR2_NSTN}, // S_PLAY_NIGHTS_STUN
	{SPR_PLAY, 0, -1, {NULL}, 0, 0, S_NULL, SPR2_NPUL}, // S_PLAY_NIGHTS_PULL
	{SPR_PLAY, 0, -1, {NULL}, 0, 0, S_NULL, SPR2_NATK}, // S_PLAY_NIGHTS_ATTACK

	// c:
	{SPR_PLAY, FF_SPR2MIDSTART, -1, {NULL}, 0, 0, S_NULL, SPR2_TAL0}, // S_TAILSOVERLAY_STAND
	{SPR_PLAY, FF_SPR2MIDSTART, -1, {NULL}, 0, 0, S_NULL, SPR2_TAL1}, // S_TAILSOVERLAY_0DEGREES
	{SPR_PLAY, FF_SPR2MIDSTART, -1, {NULL}, 0, 0, S_NULL, SPR2_TAL2}, // S_TAILSOVERLAY_PLUS30DEGREES
	{SPR_PLAY, FF_SPR2MIDSTART, -1, {NULL}, 0, 0, S_NULL, SPR2_TAL3}, // S_TAILSOVERLAY_PLUS60DEGREES
	{SPR_PLAY, FF_SPR2MIDSTART, -1, {NULL}, 0, 0, S_NULL, SPR2_TAL4}, // S_TAILSOVERLAY_MINUS30DEGREES
	{SPR_PLAY, FF_SPR2MIDSTART, -1, {NULL}, 0, 0, S_NULL, SPR2_TAL5}, // S_TAILSOVERLAY_MINUS60DEGREES
	{SPR_PLAY, FF_SPR2MIDSTART, -1, {NULL}, 0, 0, S_NULL, SPR2_TAL6}, // S_TAILSOVERLAY_RUN
	{SPR_PLAY, FF_SPR2MIDSTART, -1, {NULL}, 0, 0, S_NULL, SPR2_TAL7}, // S_TAILSOVERLAY_FLY
	{SPR_PLAY, FF_SPR2MIDSTART, -1, {NULL}, 0, 0, S_NULL, SPR2_TAL8}, // S_TAILSOVERLAY_TIRE
	{SPR_PLAY, FF_SPR2MIDSTART, -1, {NULL}, 0, 0, S_NULL, SPR2_TAL9}, // S_TAILSOVERLAY_PAIN
	{SPR_PLAY, FF_SPR2MIDSTART, -1, {NULL}, 0, 0, S_NULL, SPR2_TALA}, // S_TAILSOVERLAY_GASP
	{SPR_PLAY,               0, -1, {NULL}, 0, 0, S_NULL, SPR2_TALB}, // S_TAILSOVERLAY_EDGE
	{SPR_PLAY, FF_SPR2MIDSTART, -1, {NULL}, 0, 0, S_NULL, SPR2_TALC}, // S_TAILSOVERLAY_DASH
