...
state_t states[NUMSTATES] =
{
	...
	// CA2_SPINDASH
	{SPR_PLAY, 0, 2, {NULL}, 0,  0, S_PLAY_SPINDASH, SPR2_SPIN}, // S_PLAY_SPINDASH

	// CA_FLY/CA_SWIM
	{SPR_PLAY, 0,  2, {NULL}, 0,  0, S_PLAY_FLY,       SPR2_FLY},  // S_PLAY_FLY
	{SPR_PLAY, 0,  4, {NULL}, 0,  0, S_PLAY_SWIM,      SPR2_SWIM}, // S_PLAY_SWIM
	{SPR_PLAY, 0, 12, {NULL}, 0,  0, S_PLAY_FLY_TIRED, SPR2_TIRE}, // S_PLAY_FLY_TIRED

	// CA_GLIDEANDCLIMB
	{SPR_PLAY, 0,  2, {NULL}, 0,  0, S_PLAY_GLIDE, SPR2_GLID}, // S_PLAY_GLIDE
	{SPR_PLAY, 0,  7, {NULL}, 0,  0, S_PLAY_STND,  SPR2_LAND}, // S_PLAY_GLIDE_LANDING
	{SPR_PLAY, 0, -1, {NULL}, 0,  4, S_NULL,       SPR2_CLNG}, // S_PLAY_CLING
	{SPR_PLAY, 0,  5, {NULL}, 0,  0, S_PLAY_CLIMB, SPR2_CLMB}, // S_PLAY_CLIMB

	// CA_FLOAT/CA_SLOWFALL
	{SPR_PLAY, 0, 7, {NULL}, 0,  0, S_PLAY_FLOAT,     SPR2_FLT},  // S_PLAY_FLOAT
	{SPR_PLAY, 0, 7, {NULL}, 0,  0, S_PLAY_FLOAT_RUN, SPR2_FRUN}, // S_PLAY_FLOAT_RUN

	// CA_BOUNCE
	{SPR_PLAY, 0, -1, {NULL},             0,  0, S_NULL,                SPR2_BNCE}, // S_PLAY_BOUNCE
	{SPR_PLAY, 0,  2, {NULL}, S_PLAY_BOUNCE,  0, S_PLAY_BOUNCE_LANDING, SPR2_LAND}, // S_PLAY_BOUNCE_LANDING

	// CA2_GUNSLINGER
	{SPR_PLAY, 0,  2, {NULL}, S_PLAY_FIRE_FINISH, 0, S_PLAY_FIRE, SPR2_FIRE}, // S_PLAY_FIRE
	{SPR_PLAY, 0, 15, {NULL},        S_PLAY_STND, 0, S_PLAY_STND, SPR2_FIRE}, // S_PLAY_FIRE_FINISH

	// CA_TWINSPIN
	{SPR_PLAY, 0, 2, {NULL}, S_PLAY_JUMP, 0, S_PLAY_TWINSPIN, SPR2_TWIN}, // S_PLAY_TWINSPIN

	// CA2_MELEE
	{SPR_PLAY, 0,  2, {NULL}, S_PLAY_MELEE_FINISH, 0, S_PLAY_MELEE, SPR2_MLEE}, // S_PLAY_MELEE
	{SPR_PLAY, 0, 70, {NULL},                   0, 0, S_PLAY_FALL,  SPR2_MLEE}, // S_PLAY_MELEE_FINISH
	{SPR_PLAY, 0, 35, {NULL},                   0, 0, S_PLAY_WALK,  SPR2_MLEL}, // S_PLAY_MELEE_LANDING

	// SF_SUPER
	{SPR_PLAY, SPR2F_SUPER|FF_ANIMATE,     7, {NULL},          0, 4, S_PLAY_SUPER_TRANS2, SPR2_TRNS}, // S_PLAY_SUPER_TRANS1
	{SPR_PLAY, SPR2F_SUPER,                3, {NULL},          0, 0, S_PLAY_SUPER_TRANS3, SPR2_TRNS}, // S_PLAY_SUPER_TRANS2
	{SPR_PLAY, SPR2F_SUPER|FF_FULLBRIGHT,  2, {NULL},          0, 0, S_PLAY_SUPER_TRANS4, SPR2_TRNS}, // S_PLAY_SUPER_TRANS3
	{SPR_PLAY, SPR2F_SUPER|FF_FULLBRIGHT,  2, {NULL},          0, 0, S_PLAY_SUPER_TRANS5, SPR2_TRNS}, // S_PLAY_SUPER_TRANS4
	{SPR_PLAY, SPR2F_SUPER|FF_FULLBRIGHT,  2, {NULL},          0, 0, S_PLAY_SUPER_TRANS6, SPR2_TRNS}, // S_PLAY_SUPER_TRANS5
	{SPR_PLAY, SPR2F_SUPER|FF_FULLBRIGHT, 19, {A_FadeOverlay}, 0, 0, S_PLAY_FALL,         SPR2_TRNS}, // S_PLAY_SUPER_TRANS6

	{SPR_NULL, 0, -1, {NULL}, 0, 0, S_OBJPLACE_DUMMY, 0}, //S_OBJPLACE_DUMMY

	// 1-Up box sprites (uses player sprite)
	{SPR_PLAY, 0,  2, {NULL}, 0, 18, S_PLAY_BOX2,  SPR2_LIFE}, // S_PLAY_BOX1
	{SPR_NULL, 0,  1, {NULL}, 0, 18, S_PLAY_BOX1,  0},         // S_PLAY_BOX2
	{SPR_PLAY, 0,  4, {NULL}, 0,  4, S_PLAY_ICON2, SPR2_LIFE}, // S_PLAY_ICON1
	{SPR_NULL, 0, 12, {NULL}, 0,  4, S_PLAY_ICON3, 0},         // S_PLAY_ICON2
	{SPR_PLAY, 9, 20, {NULL}, 0,  4, S_NULL,       SPR2_LIFE}, // S_PLAY_ICON3

	// Level end sign (uses player sprite)
	{SPR_PLAY, FF_PAPERSPRITE, 2, {NULL}, 0, 29, S_PLAY_SIGN, SPR2_SIGN}, // S_PLAY_SIGN

	// NiGHTS Player, transforming
	{SPR_PLAY,             0,  7, {NULL},          0, 4, S_PLAY_NIGHTS_TRANS2, SPR2_TRNS}, // S_PLAY_NIGHTS_TRANS1
	{SPR_PLAY,             0,  3, {NULL},          0, 0, S_PLAY_NIGHTS_TRANS3, SPR2_TRNS}, // S_PLAY_NIGHTS_TRANS2
	{SPR_PLAY, FF_FULLBRIGHT,  2, {NULL},          0, 0, S_PLAY_NIGHTS_TRANS4, SPR2_TRNS}, // S_PLAY_NIGHTS_TRANS3
	{SPR_PLAY, FF_FULLBRIGHT,  2, {NULL},          0, 0, S_PLAY_NIGHTS_TRANS5, SPR2_TRNS}, // S_PLAY_NIGHTS_TRANS4
	{SPR_PLAY, FF_FULLBRIGHT,  2, {NULL},          0, 0, S_PLAY_NIGHTS_TRANS6, SPR2_TRNS}, // S_PLAY_NIGHTS_TRANS5
	{SPR_PLAY, FF_FULLBRIGHT, 21, {A_FadeOverlay}, 2, 0, S_PLAY_NIGHTS_FLOAT,  SPR2_TRNS}, // S_PLAY_NIGHTS_TRANS5

	// NiGHTS Player
	{SPR_PLAY, 0, 7, {NULL}, 0, 0, S_PLAY_NIGHTS_STAND,  SPR2_NSTD}, // S_PLAY_NIGHTS_STAND
	{SPR_PLAY, 0, 7, {NULL}, 0, 0, S_PLAY_NIGHTS_FLOAT,  SPR2_NFLT}, // S_PLAY_NIGHTS_FLOAT
	{SPR_PLAY, 0, 2, {NULL}, 0, 0, S_PLAY_NIGHTS_FLY,    SPR2_NFLY}, // S_PLAY_NIGHTS_FLY
	{SPR_PLAY, 0, 2, {NULL}, 0, 0, S_PLAY_NIGHTS_DRILL,  SPR2_NDRL}, // S_PLAY_NIGHTS_DRILL
	{SPR_PLAY, 0, 2, {NULL}, 0, 0, S_PLAY_NIGHTS_STUN,   SPR2_NSTN}, // S_PLAY_NIGHTS_STUN
	{SPR_PLAY, 0, 1, {NULL}, 0, 0, S_PLAY_NIGHTS_PULL,   SPR2_NPUL}, // S_PLAY_NIGHTS_PULL
	{SPR_PLAY, 0, 1, {NULL}, 0, 0, S_PLAY_NIGHTS_ATTACK, SPR2_NATK}, // S_PLAY_NIGHTS_ATTACK

	// c:
	{SPR_PLAY, FF_SPR2MIDSTART,  5, {NULL}, 0, 0, S_TAILSOVERLAY_STAND,          SPR2_TAL0}, // S_TAILSOVERLAY_STAND
	{SPR_PLAY, FF_SPR2MIDSTART, 35, {NULL}, 0, 0, S_TAILSOVERLAY_0DEGREES,       SPR2_TAL1}, // S_TAILSOVERLAY_0DEGREES
	{SPR_PLAY, FF_SPR2MIDSTART, 35, {NULL}, 0, 0, S_TAILSOVERLAY_PLUS30DEGREES,  SPR2_TAL2}, // S_TAILSOVERLAY_PLUS30DEGREES
	{SPR_PLAY, FF_SPR2MIDSTART, 35, {NULL}, 0, 0, S_TAILSOVERLAY_PLUS60DEGREES,  SPR2_TAL3}, // S_TAILSOVERLAY_PLUS60DEGREES
	{SPR_PLAY, FF_SPR2MIDSTART, 35, {NULL}, 0, 0, S_TAILSOVERLAY_MINUS30DEGREES, SPR2_TAL4}, // S_TAILSOVERLAY_MINUS30DEGREES
	{SPR_PLAY, FF_SPR2MIDSTART, 35, {NULL}, 0, 0, S_TAILSOVERLAY_MINUS60DEGREES, SPR2_TAL5}, // S_TAILSOVERLAY_MINUS60DEGREES
	{SPR_PLAY, FF_SPR2MIDSTART, 35, {NULL}, 0, 0, S_TAILSOVERLAY_RUN,            SPR2_TAL6}, // S_TAILSOVERLAY_RUN
	{SPR_PLAY, FF_SPR2MIDSTART,  4, {NULL}, 0, 0, S_TAILSOVERLAY_FLY,            SPR2_TAL7}, // S_TAILSOVERLAY_FLY
	{SPR_PLAY, FF_SPR2MIDSTART,  4, {NULL}, 0, 0, S_TAILSOVERLAY_TIRE,           SPR2_TAL8}, // S_TAILSOVERLAY_TIRE
	{SPR_PLAY, FF_SPR2MIDSTART, 35, {NULL}, 0, 0, S_TAILSOVERLAY_PAIN,           SPR2_TAL9}, // S_TAILSOVERLAY_PAIN
	{SPR_PLAY, FF_SPR2MIDSTART, 35, {NULL}, 0, 0, S_TAILSOVERLAY_GASP,           SPR2_TALA}, // S_TAILSOVERLAY_GASP
	{SPR_PLAY,               0, 35, {NULL}, 0, 0, S_TAILSOVERLAY_EDGE,           SPR2_TALB}, // S_TAILSOVERLAY_EDGE
	{SPR_PLAY, FF_SPR2MIDSTART, 35, {NULL}, 0, 0, S_TAILSOVERLAY_DASH,           SPR2_TALC}, // S_TAILSOVERLAY_DASH
	...
	// Metal Sonic
	{SPR_PLAY, 0, -1, {NULL}, 0, 0, S_METALSONIC_RACE, SPR2_STND}, // S_METALSONIC_RACE
